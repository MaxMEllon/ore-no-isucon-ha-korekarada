...
const { validateOrganizations, validateUsername, validatePassword } = require('../utils/validator')
...
const storage = multer.diskStorage({
  ...
  filename(req, file, cb) {
    ...
    cb(null, `${req.body.username}-${Date.now()}.${uuid()}.${mimes.extension(file.mimetype)}`)
  }
})
